...
CREATE TABLE IF NOT EXISTS tasks (
  ...
  state TEXT DEFAULT 'CREATED' CHECK (state IN ('CREATED', 'PLANNING', 'READY', 'BUILDING', 'REVIEWING', 'PR_CREATED', 'WAITING_APPROVAL', 'MERGED', 'COMPLETED', 'FAILED', 'BLOCKED', 'CANCELLED')),
